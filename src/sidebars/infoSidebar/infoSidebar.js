      ...
      return (
        <div className="column-flex-container">
          <div className={"info-sidebar"}>
              ...
              <p className={"info-graf"}>Want to set a reminder for a release? Click on a release, click "Add to favorites" and then click "Export to ICS" in the favorites bar. Your browser will download a calendar file you can import into the calendar of your choosing</p>
              <p className={"info-graf"}>Want to navigate to a specific date? Do it like this: https://vgcal.now.sh/date/12-31-2020</p>
